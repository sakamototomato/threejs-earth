import { MeshBasicMaterial, Mesh, Vector3, PlaneGeometry, DoubleSide, Group, Texture } from "three";
import { lon2xyz } from "./common";
import { punctuation } from "../earth";
...
export const createLightPillar = (options: {
    ...
    index: number, textures: Record<string, Texture>, punctuation: punctuation
}) => {
